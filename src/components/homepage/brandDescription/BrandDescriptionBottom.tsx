...
const BrandDescriptionBottom: React.FC<Props> = ({ locale }) => {
     return (
          <div className="relative w-full h-auto aspect-[1.5/1] sm:aspect-video lg:aspect-[1854/642]">
               ...
               <Container className="w-full h-full flex items-end text-white font-medium text-[14px] sm:text-[16px] md:text-[20px] leading-130% pb-10">
                    <div className="max-w-full sm:max-w-[70%] lg:max-w-[50%] relative z-10">
