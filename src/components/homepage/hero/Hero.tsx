    ...
    <section className="w-full h-screen relative overflow-hidden text-white">
      ...
      <Container className="w-full h-full flex flex-col items-center justify-center">
        ...
        <p className="mt-[30px] text-[16px] leading-130% max-w-full text-center font-medium lg:text-[22px] lg:max-w-[70%]">
          Мы являемся официальными представителями Midea и Welkin. У нас вы можете купить как бытовые, так и промышленные кондиционеры для
          обеспечения комфортного климата в квартирах, офисах и производственных помещениях. Мы предлагаем выгодные условия сотрудничества и
          сервис, ориентированный на долгосрочную надёжность и экономию.
        </p>
