     ...
     return (
          <section className="w-full h-screen relative overflow-hidden text-white">
               ...
               <Container className="w-full h-full flex flex-col items-center justify-center">
                    <h1 className="leading-130% text-[45px] font-semibold text-center">Бытовые и промышленные кондиционеры от компании Midea</h1>
                    ...
                    <CommonButton className="mt-[60px]" href={`/${locale}/catalog`}>
                         Каталог
                    </CommonButton>
               </Container>
