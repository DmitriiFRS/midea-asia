...
const Filtration: React.FC<Props> = ({ locale }) => {
    ...
    return <div className="flex items-center gap-5 max-h-10">
        <span className="text-[16px] font-semibold">Бренд:</span>
        <Select value={brand ?? ""} onChange={handleChange} displayEmpty MenuProps={{
        ...
        }} className="h-full" renderValue={brand !== '' ? undefined : () => <span>Выбрать</span>}>
